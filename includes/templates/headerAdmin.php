...
<body>
    <header id="#header" class="header">
        <div class="barra header-contenedor">
            ...
            <aside>
                <a href="/admin/index.php" class="navegacion__enlace">Inicio</a>
                <a href="/admin/reseña.php" class="navegacion__enlace">Reseñas</a>
            </aside>
    ...
    <?php if ($inicio): ?>
        <div id="inicio" class="contenido">
            <div class="contenido__principal">
                <p class="p1">Un página bien administrada es una página agradable!</p>
                <p class="p2">Al mercado le importa muy poco quiénes somos, qué hacemos o qué experiencia tenemos, lo que realmente les importa es lo que podemos hacer por ellos.</p>
            </div>
        </div><!-- CONTENIDO -->
    <?php endif; ?>